...
with st.form("Bill Invoice", clear_on_submit=True):
    ...
    product_category = st.selectbox("Product Category", ("Temper glass","Phone Case","Earphone / Headphone", "Combo", "Service","CC Pin","Battery", "CC Board", "V8 Charger", "Type C Charger", "Keypad Charger", "Neckband","Airpod","Keypad Phone", "Speaker", "Other"))
